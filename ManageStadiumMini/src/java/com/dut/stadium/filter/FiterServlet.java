    ...
    public void doFilter(ServletRequest request, ServletResponse response,
     ...
     String userid = null;
        ...
        if (userid == null) {
            ...
            listpermission.add("login.do");
            listpermission.add("getTimeSlot.do");
            listpermission.add("getCalendar.do");
            listpermission.add("EmailExisted.do");
            listpermission.add("BookYard.do");
            listpermission.add("logout.do");
            ...
            try {
                ...
                if (rs_staff.next()) {
                    if (rs_staff.getString("Position") == "Employee") {
                        ...
                        //Them cac tinh nang
                        listpermission.add("UpdateCustomer.do");
                        listpermission.add("UpdateStaff.do");
                        listpermission.add("Createstaff.do");
                        listpermission.add("Createcustomer.do");
                        listpermission.add("addYard.do");
                        listpermission.add("editYard.do");
