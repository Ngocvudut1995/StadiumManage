...
<%@page import="com.dut.stadium.model.HomeView"%>
                    ...
                    <div class="col-sm-3">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <a href="yard.jdp?id=<%=item.getIDYard()%>"><img src="<%=item.getImage()%>" class="img-responsive" style="width: 100%" alt="Image"></a>
                            </div>
                            <div class="panel-footer"><a href="yard.jdp?id=<%=item.getIDYard()%>"><%=item.getNameYard()%></a></div>
                        </div>
                    </div>
                    <%   }%>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <a href="<%=item.getIDYard()%>"><img src="<%=item.getImage()%>" class="img-responsive" style="width: 100%" alt="Image"></a>
                        </div>
                        <div class="panel-footer">
                            <a href="<%=item.getIDYard()%>"><%=item.getNameYard()%></a>
                        </div>
                    </div>
                </div>
                <% }%>
