...
if (true)
 ...
 if (true)
      ...
      out.write("                        Quản lý chi phí hóa đơn\n");
      out.write("                    </h4>\n");
      out.write("                </div>\n");
      out.write("               \n");
      ...
      out.write("                                    <thead>\n");
      out.write("                                    <tr class=\"table_bill info\">\n");
      out.write("                                        <th>Mã hóa đơn <a onclick=\" sort('id') \"> <i class=\"fa fa-sort\" aria-hidden=\"true\"></i></a></th>\n");
      out.write("                                        <th>Tên nhân viên <a onclick=\" sort('namestaff') \"> <i class=\"fa fa-sort\" aria-hidden=\"true\"></i></a></th>\n");
      out.write("                                        <th>Mã sân <a onclick=\" sort('yard') \"> <i class=\"fa fa-sort\" aria-hidden=\"true\"></i></a></th>\n");
      out.write("                                        <th>Tên sân <a onclick=\" sort('nameyard') \"> <i class=\"fa fa-sort\" aria-hidden=\"true\"></i></a></th>\n");
      out.write("                                        <th>Khung giờ <a onclick=\" sort('tslot') \"> <i class=\"fa fa-sort\" aria-hidden=\"true\"></i></a></th>\n");
      out.write("                                        <th>Khách hàng <a onclick=\" sort('namecustomer') \"> <i class=\"fa fa-sort\" aria-hidden=\"true\"></i></a></th>\n");
      out.write("                                        <th>Tình trạng <a onclick=\" sort('status') \"> <i class=\"fa fa-sort\" aria-hidden=\"true\"></i></a></th>\n");
      out.write("                                        <th>Giá cả <a onclick=\" sort('price') \"> <i class=\"fa fa-sort\" aria-hidden=\"true\"></i></a></th>\n");
      out.write("                                        <th>Thời gian thanh toán <a onclick=\" sort('date') \"> <i class=\"fa fa-sort\" aria-hidden=\"true\"></i></a></th>\n");
      out.write("                                    </tr>\n");
      out.write("                                    </thead>\n");
      out.write("                                    ");
 ...
 try {
      ...
      out.write("</td>\n");
      out.write("                                                <td>");
      out.print(item.AccountStaff.getNameAccount());
      out.write("</td>\n");
      out.write("                                                <td>");
      out.print(item.Bill.getIDYard());
      out.write("</td>\n");
      out.write("                                                <td>");
      out.print(item.Yard.getNameYard());
      out.write("</td>\n");
      out.write("                                                <td>");
      out.print(item.TimeSlot);
      out.write("</td>\n");
      out.write("                                                <td>");
      out.print(item.AccountCustomer.getNameAccount());
      out.write("</td>\n");
      out.write("                                                <td>\n");
      out.write("                                                    ");
if (item.Bill.isStatus() == true)
      ...
      out.write("</td>\n");
      out.write("                                            <td>");
      out.print(item.Bill.getDatePay());
      out.write("</td>\n");
      out.write("                                        </tr>\n");
      out.write("                                        ");
}} catch (Exception e) {
      ...
      out.write("            $('#table_bill tbody tr').removeClass('success');\n");
